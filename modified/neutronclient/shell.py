...
from neutronclient.neutron.v2_0.instantvpn import instantvpn
...
COMMAND_V2 = {
    ...
    'instantvpn-create':instantvpn.CreateInstantVpn,
    'instantvpn-delete':instantvpn.DeleteInstantVpn,
    'instantvpn-list':instantvpn.ListInstantVpn,
}
