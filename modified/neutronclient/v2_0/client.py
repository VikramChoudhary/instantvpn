...
class Client(object):
    ...
    instantvpns_path = "/instantvpn/instantvpns"
    instantvpn_path = "/instantvpn/instantvpns/%s"
    ...
    @APIParamsCall
    def list_instantvpns(self, retrieve_all=True, **_params):
        """Fetches a list of all instantvpns for a tenant."""
        return self.list('instantvpns', self.instantvpns_path, retrieve_all,
                         **_params)
     
    @APIParamsCall
    def create_instantvpn(self, body=None):
        """Creates a new instantvpn entry."""
        return self.post(self.instantvpns_path, body=body)
     
    @APIParamsCall
    def delete_instantvpn(self, instantvpn):
        """Deletes the specified instantvpn."""
        return self.delete(self.instantvpn_path % (instantvpn))
